...
Input data for verification #8 - Simply supported beam under distributed load. Eg. 5.2.2 EBT, Eg. 5.3.2 TBT in NL-FEM-Reddy book 2nd edition. Half beam analysed.
'''
...
# Need to contraint all DOFs atleast.
inputEBC = {'globalNode#': [[0,8], [5,2]], # [node number], [no of boundary values at node]
            'Values': [[0,0],[2,0],[1,0],[3,0],[5,0],[2,0],[4,0]] # [DOF #, value] # 1=Ty, 0=Tx, 4=Ry
        }
