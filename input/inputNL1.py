...
Input data for verification #1- Cantilever beam with point load along X and Y direction.
'''
...
inputNBC = {'globalNode#': [[5], [2]], # [node number], [no of boundary values at node]
            'Values': [[0, -5_000],[1, -5_000]] # [DOF #, value], 0=Tx, 1=Ty, 3=Rx
        }
