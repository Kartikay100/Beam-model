...
Input data for SFBM verification # 2- Pin-pin beam with multiple point load
'''
...
inputNBC = {'globalNode#': [[27, 45, 72], [1,1,1]], 
            'Values': [[1, 100], [1, 200], [1, 75]] 
        }

inputForce = {'globalNode#': [[0], [0]], # [node number], [no of boundary values at node]
            'Values': [[0, 0]] # [DOF #, value], 0=Tx
        }
