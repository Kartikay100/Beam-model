...
Input data for SFBM verification # 11- SSB with point force and point moment load.
'''
...
inputEBC = {'globalNode#': [[0, 80], [3,2]], # [node number], [no of boundary values at node]    
        'Values': [[0,0],[1,0],[2,0],[0,0],[1,0]] # [DOF #, value] # 1=Ty, 0=Tx, 4=Ry
        }
inputNBC = {'globalNode#': [[10, 30, 50], [1, 1, 1]], 
            'Values': [[0, -8*x], [4, -6*x], [4, -12*x]] 
        }
